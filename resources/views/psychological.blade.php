...
@section('content')
   ...
   <div style="display: none;" id="hidden-content">
      ...
      {!! Form::open(['id' => 'mailForm', 'class' => 'searchform']) !!}
         ...
         {!! Form::select('specialist', [ '' => '', 'Кудрявцев Денис Юрьевич' => 'Кудрявцев Денис Юрьевич', 'Новосёлова Наталья Федоровна' => 'Новосёлова Наталья Федоровна', 'Чхеидзе Мариам Автандиловна' => 'Чхеидзе Мариам Автандиловна'], '', ['style' => 'width: 100%; display: block;']) !!}
