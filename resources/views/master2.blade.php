...
<head>
   ...
   <link rel="stylesheet" type="text/css" href="{{URL::to('/')}}/public/css/styles2.css" />
   ...
   <div class="container">
      <nav>
         <div class="menuContainer">
            <div class="logo">
               <a href="{{URL::to('/')}}">
                  <img src="{{URL::to('/')}}/public/img/logo_white.png" alt="Дом молодежи Василеостровского района" title="Дом молодежи Василеостровского района">
               </a>
            </div>
