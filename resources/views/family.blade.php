...
@section('content')
   ...
   <!-- <div class='photo_news'>
      <a href="{{ URL::to('/') }}/public/img/online_1.jpg" data-fancybox="gallery"><img src="{{ URL::to('/') }}/public/img/online_1.jpg" class="photo1 photo_of_event"></a>
      <a href="{{ URL::to('/') }}/public/img/online_2.jpg" data-fancybox="gallery"><img src="{{ URL::to('/') }}/public/img/online_2.jpg" class="photo1 photo_of_event"></a>
      <a href="{{ URL::to('/') }}/public/img/online_3.jpg" data-fancybox="gallery"><img src="{{ URL::to('/') }}/public/img/online_3.jpg" class="photo1 photo_of_event"></a>
      <a href="{{ URL::to('/') }}/public/img/online_4.jpg" data-fancybox="gallery"><img src="{{ URL::to('/') }}/public/img/online_4.jpg" class="photo1 photo_of_event"></a>
   </div>
   ...
   <div id="content">
      <h2 style="margin-top: 15px;">Мероприятия семейного клуба «ДМВО»</h2>
