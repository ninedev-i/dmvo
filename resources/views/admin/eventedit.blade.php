...
@section('content')
  ...
  <table class="admintable">
    <tr><td>{!! Form::label('date_from', 'Когда') !!}</td><td>{!! Form::date('date_from', $content->date_from) !!} - {!! Form::date('date_to', $content->date_to) !!} в {!! Form::time('what_time', $content->what_time) !!}</td></tr>
    <tr><td>{!! Form::label('title', 'Название') !!}</td><td>  {!! Form::text('title', $content->title) !!}</td></tr>
    <tr><td>Анонс<br /><input type="radio" id="showtext1" name="whattoshow1" checked><label for="showtext1">текст</label><input type="radio" name="whattoshow1" id="showhtml1"><label for="showhtml1">html</label></td><td><div class="mycontent1" contenteditable></div>{!! Form::textarea('content', $content->content, ['class' => 'hiddenarea1']) !!}</td></tr>
    <tr><td>Пост-релиз<br /><input type="radio" id="showtext2" name="whattoshow2" checked><label for="showtext2">текст</label><input type="radio" name="whattoshow2" id="showhtml2"><label for="showhtml2">html</label></td><td><div class="mycontent2" contenteditable></div>{!! Form::textarea('post_reliz', $content->post_reliz, ['class' => 'hiddenarea2']) !!}</td></tr>
   ...
   <tr><td>Удалить мероприятие?</td><td>
