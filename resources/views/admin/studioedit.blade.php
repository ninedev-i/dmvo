...
@section('content')
  ...
  <table class="admintable">
   ...
   <tr><td>{!! Form::label('direction', 'Теги') !!}</td><td>
    ...
    <tr><td>Расписание<br /><input type="radio" id="showtext" name="whattoshow" checked><label for="showtext">текст</label><input type="radio" name="whattoshow" id="showhtml"><label for="showhtml">html</label></td><td><div class="mycontent" contenteditable></div>{!! Form::textarea('timetable', $content->timetable, ['class' => 'hiddenarea']) !!}</td></tr>
